...
import sys
"""
Putting in my implementation of PPO
"""
sys.path.append('/home/accl/path_planning_ws/src/Hospitalbot-Path-Planning/hospital_robot_spawner/hospital_robot_spawner/')
...
def main(args=None):
    ...
    pkg_dir = 'path_planning_ws/src/Hospitalbot-Path-Planning/hospital_robot_spawner'
...
# THIS IS WHERE OUR IMPLEMENTATION SHOULD BE
        ...
        # Execute training
        try:
            model.learn(total_timesteps=int(20000000), reset_num_timesteps=False, callback=eval_callback, tb_log_name="jess5_PPO_test")
        except KeyboardInterrupt:
            model.save(f"{trained_models_dir}/jess5_PPO_test")
...
def optimize_agent(trial):
    ...
    try:
        ...
        # Setup dirs
        HOME_DIR = os.path.expanduser('~')
        PKG_DIR = 'ros2_ws_robot/src/Hospitalbot-Path-Planning/hospital_robot_spawner'
        LOG_DIR = os.path.join(HOME_DIR, PKG_DIR, 'logs')
